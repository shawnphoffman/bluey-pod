...
export default async function RatingsGoodpods() {
	...
	return (
		<a
			className="flex flex-row items-center px-2 py-1 text-sm font-bold leading-normal text-black border-4 rounded-lg whitespace-nowrap bg-goodpods bubble-border"
